...
# -*- coding: utf-8 -*-
#
# orca_step documentation build configuration file,
...
version = orca_step.__version__
# The full version, including alpha/beta/rc tags.
release = orca_step.__version__
...
htmlhelp_basename = 'orca_stepdoc'
