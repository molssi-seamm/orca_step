...
"""Non-graphical part of the ORCA step in a SEAMM flowchart
"""
...
class Orca(seamm.Node):
    """
    The non-graphical part of a ORCA step in a flowchart.
    ...
    parameters : OrcaParameters
        The control parameters for ORCA.
    ...
    def __init__(
        ...
        """A step for ORCA in a SEAMM flowchart.
    ...
    def description_text(self, P=None):
        ...
        while node is not None:
            try:
                ...
                print(
                    f"Error describing orca flowchart: {e} in {node}"
                )
                logger.critical(
                    f"Error describing orca flowchart: {e} in {node}"
                )
                ...
                print(
                    "Unexpected error describing orca flowchart: "
    ...
    def run(self):
        ...
        result = local.run(
            cmd=["ORCA", "-in", "molssi.dat"],
            files=files,
            return_files=[]
        )  # yapf: disable

        if result is None:
            logger.error("There was an error running ORCA")
            return None
