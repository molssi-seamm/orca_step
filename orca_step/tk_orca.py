...
"""The graphical part of a ORCA step"""
...
class TkOrca(seamm.TkNode):
    """
    The graphical part of a ORCA step in a flowchart.
    ...
    self[widget] : dict
        ...
        contained in ORCA_parameters.py
    ...
    def create_dialog(self):
        ...
        based on what is specified in the ORCA_parameters
        module.
